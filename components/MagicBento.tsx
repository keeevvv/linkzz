...
const cardData: BentoCardProps[] = [
  {
    ...
    description:
      "Make your page truly yours. Customize colors, fonts, and layouts.",
    label: "Personalize",
  },
  {
    color: "#ffffffff",
    ...
    description:
      "See exactly how many clicks each link gets and understand your audience.",
    label: "Insights",
  },
  {
    color: "#ffffffff",
    title: "All Your Content in One",
    description:
      "Embed videos, music, social feeds, and store products directly on your page.",
    label: "Rich Content",
  },
  {
    color: "#ffffffff",
    ...
    description:
      "Accept tips, sell digital products, or connect your store. Turn your links into income.",
    label: "E-commerce",
  },
  {
    color: "#ffffffff",
    title: "Share Anywhere",
    description: "Get one simple link to share on all your profiles.",
    label: "Easy Sharing",
  },
  {
    color: "#ffffffff",
    ...
    description:
      "Automatically display icons for your TikTok, Instagram, Spotify, and more.",
    label: "Connect",
  },
];
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
           box-shadow: 0 8px 25px rgba(0, 0, 0, 0.1), 0 0 30px rgba(${glowColor}, 0.3);
          }
